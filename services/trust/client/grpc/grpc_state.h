...
#ifndef BEACON_SERVICES_TRUST_CLIENT_GRPC_GRPC_STATE_H_
#define BEACON_SERVICES_TRUST_CLIENT_GRPC_GRPC_STATE_H_
...
#include "brave/services/trust/client/grpc/grpc_util.h"
...
class RPCState : public GrpcClientCQTag {
 public:
  ...
  void StartCall() {
   ...
   LOG(WARNING) << "Starting call: " << method_;
  ...
  void OnCompleted(State state) override {
    LOG(WARNING) << "Completed call: " << method_;
...
#endif  // BEACON_SERVICES_TRUST_CLIENT_GRPC_GRPC_STATE_H_
