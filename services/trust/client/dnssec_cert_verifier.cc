...
#include "brave/services/trust/client/dnssec_cert_verifier.h"
...
#include "brave/services/trust/client/client_errors.h"
                                           ...
                                           int error)
{
  ...
  *out_req = std::make_unique<Request>();
  ...
  beaconServiceClient.CallServiceMethod(grpcRequest, base::BindOnce(&Request::OnRemoteResponse, weak_req, params, verify_result, error, std::move(callback)), state_config);
}
